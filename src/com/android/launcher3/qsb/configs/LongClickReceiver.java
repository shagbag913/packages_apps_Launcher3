...
public class LongClickReceiver extends BroadcastReceiver {
    ...
    public static WeakReference<LauncherLettuce> mWeakReference = new WeakReference(null);

    public static void getWeakReference(LauncherLettuce launcher) {
        mWeakReference = new WeakReference(launcher);
    }

    @Override
    public void onReceive(Context context, Intent intent) {
        LauncherLettuce launcher = (LauncherLettuce) mWeakReference.get();
        if (launcher != null) {
