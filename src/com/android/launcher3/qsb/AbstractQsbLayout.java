...
public abstract class AbstractQsbLayout extends FrameLayout implements LauncherLayoutChangeListener, OnClickListener {
    ...
    protected void onAttachedToWindow() {
        ...
        mLauncher.getDeviceProfile().addLauncherLayoutChangedListener(this);
        requestLayout();
    }
    ...
    public View getAssistantView() {
        return findViewById(R.id.mic_icon);
    }
}