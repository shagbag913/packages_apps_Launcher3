...
/**   private void deviceIntroEvent() {
        ...
        mIsQuickEvent = true;
        mEventIntro = true;
        mEventTitle = mContext.getResources().getString(R.string.quick_event_custom_intro_welcome);
        mEventTitleSub = mContext.getResources().getString(R.string.quick_event_custom_intro_learn);
